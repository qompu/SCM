package package1.config

import package1.common.constant.SpringProfile
...
@PropertySource('file:${SPRING_BOOT_PROPERTIES_DIR}/101w.properties')
class SecondaryDataSourceLocalConfig extends SecondaryDataSourceAbstractConfig {
    ...
    SecondaryDataSourceLocalConfig() {
        ...
        assert Files.exists(Paths.get("${dir}/101w.properties")),
                "${dir}/101w.properties containing externalized datasource properties must exist"
    }
